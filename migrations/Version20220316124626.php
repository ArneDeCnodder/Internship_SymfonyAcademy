 ...
 */
final class Version20220316124626 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie MODIFY COLUMN description text CHARACTER SET utf8 COLLATE utf8_general_ci;');
    }
