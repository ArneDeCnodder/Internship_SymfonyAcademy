 ...
 */
final class Version20220316132024 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie MODIFY COLUMN description LONGTEXT CHARACTER SET utf8 COLLATE utf8_general_ci;');
    }
