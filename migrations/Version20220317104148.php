 ...
 */
final class Version20220317104148 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie CHANGE description description VARCHAR(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL ');
    }
